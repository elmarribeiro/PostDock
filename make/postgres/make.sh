...
for VALS in "POSTGRES_VERSION=9.5 REPMGR_VERSION=3.2 REPMGR_PACKAGE_VERSION=3.3.2-1.pgdg90%2b1" \
            "POSTGRES_VERSION=9.6 REPMGR_VERSION=3.2 REPMGR_PACKAGE_VERSION=3.3.2-1.pgdg90%2b1" \
            "POSTGRES_VERSION=10 REPMGR_VERSION=3.2 REPMGR_PACKAGE_VERSION=3.3.2-1.pgdg90%2b1" \
